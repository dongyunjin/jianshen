...
import com.cn.service.IFitnessProgramService;
import com.cn.util.BaseResult;

@Service
public class FitnessProgramServiceImpl implements IFitnessProgramService{
	...
	@Override
	public List<Calendar> selectByMemberId(Integer memberid) {
		List<Calendar> count = null;
		try {
			count = calendarMapper.selectByMemberId(memberid);
		} catch (Exception e) {
			e.printStackTrace();
		}		
		return count;
